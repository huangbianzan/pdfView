...
/******/ (() => {
  ...
  /******/ var __webpack_modules__ = [
    ...
    /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, "__esModule", {
        ...
        exports.VERTICAL_PADDING = //垂直填充
        exports.UNKNOWN_SCALE =  //未知的scale
        exports.TextLayerMode = //文本图层模式
        exports.SpreadMode = //传播模式
        exports.SidebarView = //侧边栏视图
        exports.ScrollMode = //滚动模式
        exports.SCROLLBAR_PADDING = //滚动条填充
        exports.RenderingStates = //呈现状态
        exports.RendererType = //呈现类型 svg or canvas
        exports.ProgressBar = //进度条
        exports.PresentationModeState = //呈现模式状态
        exports.OutputScale = //产出scale
        exports.MIN_SCALE = //最小scale
        exports.MAX_SCALE = //最大scale
        exports.MAX_AUTO_SCALE = //最大自动scale
        exports.DEFAULT_SCALE_VALUE = //默认scale值
        exports.DEFAULT_SCALE_DELTA = // 默认sacle DELTA
        exports.DEFAULT_SCALE = //默认sacle
        exports.AutoPrintRegExp =  //自动打印RegExp
          void 0;
      exports.apiPageLayoutToViewerModes = apiPageLayoutToViewerModes;  //api页面布局到查看器模式
      exports.apiPageModeToSidebarView = apiPageModeToSidebarView; //api页面模式转侧边栏视图
      exports.approximateFraction = approximateFraction; //近似分数
      exports.backtrackBeforeAllVisibleElements = backtrackBeforeAllVisibleElements; //回溯到所有可见元素之前
      exports.binarySearchFirstItem = binarySearchFirstItem; //二分查找第一项
      exports.docStyle = void 0;
      exports.getActiveOrFocusedElement = getActiveOrFocusedElement; //获得主动或集中元素
      exports.getPageSizeInches = getPageSizeInches; //获取页面大小
      exports.getVisibleElements = getVisibleElements; //获取可见元素
      exports.isPortraitOrientation = isPortraitOrientation; //是否是纵向方向
      exports.isValidRotation = isValidRotation; //是否可以旋转
      exports.isValidScrollMode = isValidScrollMode; //滚动模式是否有效
      exports.isValidSpreadMode = isValidSpreadMode;  // 是否是传播模式
      exports.noContextMenuHandler = noContextMenuHandler; //无上下文菜单处理程序
      exports.normalizeWheelEventDelta = normalizeWheelEventDelta; //正常化车轮事件Delta
      exports.normalizeWheelEventDirection = normalizeWheelEventDirection; //正常化车轮事件方向
      exports.parseQueryString = parseQueryString; //查询字符串
      exports.removeNullCharacters = removeNullCharacters; //删除空字符
      exports.roundToDivide = roundToDivide; //划分计算canvas width height
      exports.scrollIntoView = scrollIntoView; //视图滚动方法
      ...
      function normalizeWheelEventDirection(evt) {
        //Math.hypot()就先计算所有参数的平方和，再将该和的平方根作为最终返回值
    ...
    /* 2 兼容性参数默认值设置 compatibilityParams */
    /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
      ...
      exports.compatibilityParams = compatibilityParams;
      {
        ...
        const platform = navigator.platform || ""; // 浏览器硬件平台
        const maxTouchPoints = navigator.maxTouchPoints || 1; //字面意思是最大的触摸点，IE为0，其他不支持
        const isAndroid = /Android/.test(userAgent); // 是否是android设备
        const isIOS = /\b(iPad|iPhone|iPod)(?=;)/.test(userAgent) || (platform === "MacIntel" && maxTouchPoints > 1); // 是否是ios设备
        (function checkCanvasSizeLimitation() {
          if (isIOS || isAndroid) {
            compatibilityParams.maxCanvasPixels = 5242880; // canvas渲染的最大像素
          }
        })();
      }
      const OptionKind = {
    ...
    /* 3 PDF链接服务分页问题 SimpleLinkService */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFLinkService {
        ...
        cachePageRef(pageNum, pageRef) {
          ...
          this.#pagesRefCache.set(refStr, pageNum); // 页面缓存设置
        }
        _cachedPageNumber(pageRef) {
          ...
          const refStr = pageRef.gen === 0 ? `${pageRef.num}R` : `${pageRef.num}R${pageRef.gen}`;
          return this.#pagesRefCache.get(refStr) || null; // 页面缓存获取
        }
    ...
    /* 4 PDF浏览器应用程序全部渲染事件绑定 PDFViewerApplication */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
      ...
      const PDFViewerApplication = {
        ...
        async open(file, args) {
          ...
          parameters.url = "http://192.168.100.120:2026/apigate/platform-atom/public/download?token=6166366e725937384870"
        ...
        progress(level) {
          ...
          const disableAutoFetch = this.pdfDocument?.loadingParams.disableAutoFetch ?? _app_options.AppOptions.get("disableAutoFetch"); //左侧为null和undefined时，才会返回右侧的数 空值合并操作符（??）
    ...
    /* 9 注释编辑器参数 AnnotationEditorParams */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
    ...
    /* 12 PDF附件查看器 PDFAttachmentViewer */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
    ...
    /* 14 PDF文档属性 PDFDocumentProperties */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
    ...
    /* 21 PDF演示模式 PDFPresentationMode*/
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
    ...
    /* 22 pdf渲染队列处理 PDFRenderingQueue*/
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
      ...
      class PDFRenderingQueue {
        ...
        renderHighestPriority(currentlyVisiblePages) { // 当前可见页面
          if (this.idleTimeout) {
    ...
    /* 23 PDF脚本管理器 PDFScriptingManager*/
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
    ...
    /* 26 PDF缩略图查看器 PDFThumbnailViewer */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
    ...
    /* 27 右侧PDF缩略图生成逻辑 TempImageFactory PDFThumbnailView */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
      ...
      var _ui_utils = __webpack_require__(1);
      var _pdfjsLib = __webpack_require__(5);
      const DRAW_UPSCALE_FACTOR = 2; //绘制高档因素
      const MAX_NUM_SCALING_STEPS = 3; // 最大数字缩放步长
      const THUMBNAIL_CANVAS_BORDER_WIDTH = 1; // 缩略图画布边框宽度
      const THUMBNAIL_WIDTH = 98; // 缩略图宽度98px
      ...
      class PDFThumbnailView {
        constructor({ container, id, defaultViewport, optionalContentConfigPromise, linkService, renderingQueue, l10n, pageColors }) {
          ...
          this.renderTask = null; //渲染任务
          this.renderingState = _ui_utils.RenderingStates.INITIAL;
          this.resume = null;
          const pageWidth = this.viewport.width,
            pageHeight = this.viewport.height,
            pageRatio = pageWidth / pageHeight;// 宽高比例
          this.canvasWidth = THUMBNAIL_WIDTH;
          this.canvasHeight = (this.canvasWidth / pageRatio) | 0;
          this.scale = this.canvasWidth / pageWidth; //缩放的比例
          this.l10n = l10n;
          ...
          anchor.onclick = function () {
            linkService.goToPage(id); // 中间跳转到指定页面位置
            return false;
          };
          this.anchor = anchor;
          const div = document.createElement("div");
          ...
          const borderAdjustment = 2 * THUMBNAIL_CANVAS_BORDER_WIDTH; // 边框宽度
        ...
        // 每次渲染完成后要重置参数
        reset() {
          this.cancelRendering(); // 取消现有的渲染进程
          this.renderingState = _ui_utils.RenderingStates.INITIAL;
          const pageWidth = this.viewport.width,
            pageHeight = this.viewport.height,
        ...
        _getPageDrawContext(upscaleFactor = 1) {
          ...
          const outputScale = new _ui_utils.OutputScale(); // window.devicePixelRatio屏幕的分辨率
        ...
        draw() {
          ...
          const { ctx, canvas, transform } = this._getPageDrawContext(DRAW_UPSCALE_FACTOR); //DRAW_UPSCALE_FACTOR默认值2,canvas宽高2倍放大
          const drawViewport = this.viewport.clone({
            scale: DRAW_UPSCALE_FACTOR * this.scale // this.scale图片与原始图片比较缩放的比例值
          });
        ...
        _reduceImage(img) {
          ...
          let reducedWidth = canvas.width << MAX_NUM_SCALING_STEPS; // 宽度扩大3倍  相当于 n = n*3
          let reducedHeight = canvas.height << MAX_NUM_SCALING_STEPS;
          const [reducedImage, reducedImageCtx] = TempImageFactory.getCanvas(reducedWidth, reducedHeight);
          while (reducedWidth > img.width || reducedHeight > img.height) {
            reducedWidth >>= 1; // reducedWidth = reducedWidth/(2*1)  相当于缩小2倍并赋值
            reducedHeight >>= 1;
          }
    ...
    /* 28 页面总数限制 销毁渲染页面数据 PagesCountLimit */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
      ...
      const PagesCountLimit = {
        FORCE_SCROLL_MODE_PAGE: 15000, // 强制滚动页面数量
        FORCE_LAZY_PAGE_INIT: 7500, // 强制懒加载页初始化
        PAUSE_EAGER_PAGE_INIT: 250 // 页面初始化
      };
      ...
      class PDFViewer {
        ...
        #enablePermissions = false; // 启用权限
        #previousContainerHeight = 0; // 容器高度
        #resizeObserver = new ResizeObserver(this.#resizeObserverCallback.bind(this)); // 调整观察者
        #scrollModePageState = null; // 页面滚动状态
        #onVisibilityChange = null; // 有关能见度更改
        #scaleTimeoutId = null;
        constructor(options) {
        ...
        setDocument(pdfDocument) {
          ...
          Promise.all([firstPagePromise, permissionsPromise])
            .then(([firstPdfPage, permissions]) => {
              ...
              console.log(firstPdfPage,"firsPdfPage")
            //   alert('11233')
              ...
              if (firstPageView) {
                ...
                this.linkService.cachePageRef(1, firstPdfPage.ref); // cachePageRef缓存页面引入
              }
              if (this._scrollMode === _ui_utils.ScrollMode.PAGE) {
                this.#ensurePageViewVisible(); //确保页面视图可见
              ...
              this.#onePageRenderedOrForceFetch().then(async () => {
                ...
                if (pdfDocument.loadingParams.disableAutoFetch || pagesCount > PagesCountLimit.FORCE_LAZY_PAGE_INIT) { // 懒加载中
        ...
        _resetView() {
          ...
          if (this._spreadMode === _ui_utils.SpreadMode.NONE && !this.isInPresentationMode) {
            ...
            const spread = document.createElement("div"); // spread传播
            spread.className = "spread";
            if (this.isInPresentationMode) { //isInPresentationMode处于演示模式
              const dummyPage = document.createElement("div"); // dummyPage虚拟页
          ...
          state.previousPageNumber = pageNumber;  // previousPageNumber前一页编号
        } 
        _scrollUpdate() {
        ...
        //   alert(JSON.stringify(this._pages)+",pages")
          for (const pageView of this._pages) {
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      var _pdfjsLib = __webpack_require__(5);
      var _ui_utils = __webpack_require__(1);
      var _annotation_editor_layer_builder = __webpack_require__(31); // 注释编辑层创建
      var _annotation_layer_builder = __webpack_require__(32);
      var _app_options = __webpack_require__(2);
      var _l10n_utils = __webpack_require__(29);
      var _struct_tree_layer_builder = __webpack_require__(33); // 结构体
      var _text_accessibility = __webpack_require__(34); // 文本的可访问性
      var _text_highlighter = __webpack_require__(35);
      var _text_layer_builder = __webpack_require__(36); // 文本层的创建
      var _xfa_layer_builder = __webpack_require__(37);
      const MAX_CANVAS_PIXELS = _app_options.compatibilityParams.maxCanvasPixels || 16777216; // canvas最大像素
      const DEFAULT_LAYER_PROPERTIES = () => { // 默认图层属性
        return null;
      };
      class PDFPageView {
        #annotationMode = _pdfjsLib.AnnotationMode.ENABLE_FORMS;
        ...
        #renderingState = _ui_utils.RenderingStates.INITIAL; // 渲染状态
        #useThumbnailCanvas = { // 使用缩略图渲染canvas
        ...
        constructor(options) {
          ...
          this.#layerProperties = options.layerProperties || DEFAULT_LAYER_PROPERTIES;  // 默认图层属性
          this.pdfPage = null;
          this.pageLabel = null;
          this.rotation = 0; // 旋转
          ...
          this.viewport = defaultViewport;
          this.pdfPageRotate = defaultViewport.rotation;
          this._optionalContentConfigPromise = options.optionalContentConfigPromise || null; // 可选内容配置promise
          this.hasRestrictedScaling = false; // 有限制缩放
          this.textLayerMode = options.textLayerMode ?? _ui_utils.TextLayerMode.ENABLE;
          this.#annotationMode = options.annotationMode ?? _pdfjsLib.AnnotationMode.ENABLE_FORMS;
          this.imageResourcesPath = options.imageResourcesPath || "";
          this.useOnlyCssZoom = options.useOnlyCssZoom || false;
          this.isOffscreenCanvasSupported = options.isOffscreenCanvasSupported ?? true; // 支持离屏画布吗
    ...
    /* 32 注释层构建器 AnnotationLayerBuilder */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
      ...
      class AnnotationLayerBuilder {
        ...
        constructor({ pageDiv, pdfPage, linkService, downloadManager, annotationStorage = null, imageResourcesPath = "", renderForms = true, l10n = _l10n_utils.NullL10n, enableScripting = false, hasJSActionsPromise = null, fieldObjectsPromise = null, annotationCanvasMap = null, accessibilityManager = null }) {
    ...
    /* 33 结构树层生成器 StructTreeLayerBuilder */
    /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
    ...
    /* 34 文本辅助管理器 TextAccessibilityManager*/
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
    ...
    /* 37 XfaHtml 打印渲染的具体代码 XfaLayerBuilder */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class BasePreferences {
        #defaults = Object.freeze({
          ...
          viewerCssTheme: 0,
          viewOnLoad: 0,
          disableAutoFetch: false, // false开启自动获取 true关闭自动获取
    ...
    /* 48 xfaHtml打印创建div getXfaHtmlForPrinting */
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
  ...
  // 开始
  // 这个条目需要包装在IIFE中，因为它需要与块中的其他模块隔离。
